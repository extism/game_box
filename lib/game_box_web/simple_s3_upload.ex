defmodule GameBoxWeb.SimpleS3Upload do
  @moduledoc """
  ...
  ## Examples
      {:ok, fields} =
        SimpleS3Upload.sign_form_upload("my-bucket",
  ...
  """
  def sign_form_upload(bucket, opts) do
    config = %{
      region: Application.get_env(:game_box, :region),
      access_key_id: Application.get_env(:game_box, :access_key_id),
      secret_access_key: Application.get_env(:game_box, :secret_access_key)
    }
